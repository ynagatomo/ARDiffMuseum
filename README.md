...
- [1.3.0 (7)] - Feb 10, 2023 `[Changed]`
    - changed generateImages(of:enableStableDiffusion:) function to adapt to
      apple/ml-stable-diffusion v0.2.0 API change on generateImages(configuration:progressHandler:)
